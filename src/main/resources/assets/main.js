...
(function(exports) {
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          return function __do() {
              var v = React.getProps($$this)();
              return React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-12") ])([ React_DOM.div([ DomOps.cn("card card-chart") ])([ React_DOM.div([ DomOps.cn("card-header") ])([  ]) ]) ]) ]);
          };
      };
...
(function(exports) {
  ...
  var showMenu = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 34, column 1 - line 34, column 31): " + [ v.constructor.name ]);
  });
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          var menuIcon = function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 146, column 7 - line 146, column 33): " + [ v.constructor.name ]);
          };
          var menuContent = function (v) {
              return function (v1) {
                  if (v instanceof Nodes && v1.node instanceof Data_Maybe.Just) {
                      return React.createLeafElement(React.reactPropFields()())(Node.reactClass)(v1.node.value0);
                  };
                  if (v instanceof Nodes) {
                  ...
                  throw new Error("Failed pattern match at Main (line 151, column 7 - line 151, column 51): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          var $$goto = function (v) {
              if (v instanceof Nodes) {
              ...
              throw new Error("Failed pattern match at Main (line 160, column 7 - line 160, column 34): " + [ v.constructor.name ]);
          };
          return function __do() {
              var v = React.getState($$this)();
              var v1 = React.getProps($$this)();
              return React_DOM.div([ DomOps.cn("wrapper") ])([ React_DOM.div([ DomOps.cn("sidebar") ])([ React_DOM.div([ DomOps.cn("sidebar-wrapper") ])([ React_DOM.ul([ DomOps.cn("nav") ])(Data_Functor.map(Data_Functor.functorArray)(function (x) {
                  return React_DOM.li((function () {
                      var $44 = Data_Eq.eq(eqMenu)(x)(v.menu);
                      if ($44) {
                  ...
                  if (v1.length === 4) {
                      return function __do() {
                          ...
                          var nodes$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 175, column 28 - line 177, column 49): " + [ v3.constructor.name ]);
                          })();
                  ...
                  if (v1.length === 4) {
                      return function __do() {
                          ...
                          var nodes$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 186, column 28 - line 188, column 49): " + [ v3.constructor.name ]);
                          })();
                  ...
                  if (v1.length === 3) {
                      return function __do() {
                          ...
                          var nodes$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 205, column 28 - line 207, column 49): " + [ v3.constructor.name ]);
                          })();
                          return React.modifyState($$this)(function (v3) {
                              return {
                                  menu: v3.menu,
