  ...
  var reactClass = (function () {
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              }) ]) ]) ]) ]) ]), React_DOM.div([ DomOps.cn("row") ])([ barChart("Translations: Search")(v.searchTs_thirdQ)(v.searchTs_points), barChart("Web Contents: Search")(v.searchWc_thirdQ)(v.searchWc_points), barChart("Static: Creation")(v.staticCreate_thirdQ)(v.staticCreate_points), barChart("Static: Generation")(v.staticGen_thirdQ)(v.staticGen_points) ]), React_DOM.div([ DomOps.cn("row") ])([ Data_Maybe.fromMaybe(React_DOM["div'"]([  ]))(Data_Functor.map(Data_Maybe.functorMaybe)(fsCard)(v.fs)), Data_Maybe.fromMaybe(React_DOM["div'"]([  ]))(Data_Functor.map(Data_Maybe.functorMaybe)(fdCard)(v.fd)) ]), React_DOM.div([ DomOps.cn("row") ])([ Data_Maybe.fromMaybe(React_DOM["div'"]([  ]))(Data_Functor.map(Data_Maybe.functorMaybe)(thrCard)(v.thr)), othCard(v) ]), React.createLeafElement(React.reactPropFields()())(Errors.reactClass)({
                  errors: v.errs,
                  showAddr: false
              }) ]);
          };
          ...
          return function __do() {
              ...
              return React_DOM.div([ DomOps.cn("wrapper" + (function () {
                  ...
                  return React_DOM.li((function () {
                      var $84 = Data_Eq.eq(eqMenu)(x)(v.menu);
                      if ($84) {
              ...
              var updateWith = function (a) {
                  ...
                  return function __do() {
                      ...
                      var v1 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 259, column 16 - line 266, column 34): " + [ cpu_mem.constructor.name ]);
                      })();
                      ...
                      var v2 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 272, column 15 - line 279, column 34): " + [ v2.constructor.name ]);
                      })();
                      var v3 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 281, column 15 - line 287, column 34): " + [ v3.constructor.name ]);
                      })();
                      var v4 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 289, column 16 - line 298, column 34): " + [ v4.constructor.name ]);
                      })();
                      ...
                      var node$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 314, column 21 - line 386, column 18): " + [ v6.constructor.name ]);
                      })();
                      ...
                      throw new Error("Failed pattern match at Main (line 388, column 9 - line 390, column 31): " + [ a.err.constructor.name ]);
                  };
              };
              return function __do() {
                  ...
                  if (v instanceof Data_Maybe.Just && v.value0 instanceof Api.MetricStat) {
                      var cpu_mem = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $125 = v.value0.value0.name === "cpu_mem";
                          if ($125) {
                      ...
                      var cpu_hour = (function () {
                          var $126 = v.value0.value0.name === "cpu.hour";
                          if ($126) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var uptime = (function () {
                          var $127 = v.value0.value0.name === "uptime";
                          if ($127) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var version = (function () {
                          var $128 = v.value0.value0.name === "v";
                          if ($128) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var fs = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $129 = v.value0.value0.name === "fs./";
                          if ($129) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var fd = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $130 = v.value0.value0.name === "fd";
                          if ($130) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var thr = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $131 = v.value0.value0.name === "thr";
                          if ($131) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                  ...
                  if (v instanceof Data_Maybe.Just && v.value0 instanceof Api.MeasureStat) {
                      ...
                      var searchTs = (function () {
                          var $138 = v.value0.value0.name === "search.ts";
                          if ($138) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var searchTs_thirdQ = (function () {
                          var $139 = v.value0.value0.name === "search.ts.thirdQ";
                          if ($139) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var searchWc = (function () {
                          var $140 = v.value0.value0.name === "search.wc";
                          if ($140) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var searchWc_thirdQ = (function () {
                          var $141 = v.value0.value0.name === "search.wc.thirdQ";
                          if ($141) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticCreate = (function () {
                          var $142 = v.value0.value0.name === "static.create";
                          if ($142) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticCreate_thirdQ = (function () {
                          var $143 = v.value0.value0.name === "static.create.thirdQ";
                          if ($143) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticGen = (function () {
                          var $144 = v.value0.value0.name === "static.gen";
                          if ($144) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticGen_thirdQ = (function () {
                          var $145 = v.value0.value0.name === "static.gen.thirdQ";
                          if ($145) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
