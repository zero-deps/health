...
(function($PS) {
  ...
  var send = function (ws) {
      var $0 = Web_Socket_WebSocket.sendArrayBufferView(ws);
      return function ($1) {
          return $0($1);
      };
  };
  var readMessageEvent = (function () {
      var $2 = Data_Maybe.maybe(Data_Either.Left.create(Data_Array.singleton("Can't get event")))(Data_Either.Right.create);
      return function ($3) {
          return $2(Web_Socket_Event_MessageEvent.fromEvent($3));
      };
  })();
  var readArrayBuffer = Foreign.unsafeReadTagged("ArrayBuffer");
  var parseMessageEvent = function (f) {
      var $4 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)((function () {
          var $6 = Data_Functor.map(Data_Functor.functorArray)(Foreign.renderForeignError);
          var $7 = Data_Array.fromFoldable(Data_List_Types.foldableList);
          return function ($8) {
              return $6($7(Data_List_NonEmpty.toList($8)));
          };
      })());
      return function ($5) {
          return $4(Control_Monad_Except.runExcept(f(Web_Socket_Event_MessageEvent.data_($5))));
      };
  };
                  ...
                  return function __do() {
                      var l = Web_Event_EventTarget.eventListener(function (x) {
                          return Data_Either.either((function () {
                              var $9 = Data_Functor["void"](Effect.functorEffect);
                              return function ($10) {
                                  return $9(failure($10));
                              };
  ...
  var onMsg = function (ws) {
      return function (success) {
          return function (failure) {
              return onMsg$prime(readArrayBuffer)(ws)(function ($11) {
                  return success(Ops_ArrayBuffer.uint8Array($11));
              })(failure);
          };
      };
  };
