  ...
  var errorReactClass = (function () {
      var render = function ($$this) {
          ...
          return function __do() {
              ...
              var props = React.getProps($$this)();
              var dt = FormatOps.dateTime(Global.readInt(10)(props.err.time))();
                  ...
                  return Data_Array.singleton((function () {
                      if (!s.expandStack) {
                          return React_DOM.td([ DomOps.cn("align-top"), React_DOM_Props.onClick(function (v) {
                              ...
                              wordBreak: "break-all"
                          }) ])([ React_DOM.text(props.err.toptrace) ]);
                      };
                      if (s.expandStack) {
                          return React_DOM.td([ DomOps.cn("align-top"), React_DOM_Props.onClick(function (v) {
                              return shortStack;
      ...
      return function __do() {
          ...
          return {
              ...
              componentDidMount: function __do() {
                  ...
                  throw new Error("Failed pattern match at YearChart (line 31, column 9 - line 35, column 36): " + [ c.constructor.name ]);
              },
              componentDidUpdate: function (p) {
                  return function (v) {
                      return function (v1) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at YearChart (line 38, column 9 - line 40, column 50): " + [ c.constructor.name ]);
                          };
                      };
                  };
              },
              componentWillUnmount: function __do() {
                  ...
                  throw new Error("Failed pattern match at YearChart (line 43, column 9 - line 47, column 50): " + [ c.constructor.name ]);
              }
          };
      };
  });
...
(function($PS) {
      ...
      return function (success) {
          return function (failure) {
              var messageEvent = (function () {
                  var $0 = Data_Maybe.maybe(Data_Either.Left.create(Data_List.singleton("Can't get event")))(Data_Either.Right.create);
                  return function ($1) {
                      return $0(Web_Socket_Event_MessageEvent.fromEvent($1));
                  };
              })();
              var bytes = (function () {
                  var $2 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)((function () {
                      var $5 = Data_Functor.map(Data_List_Types.functorList)(Foreign.renderForeignError);
                      return function ($6) {
                          return $5(Data_List_NonEmpty.toList($6));
                      };
                  })());
                  var $3 = Foreign.unsafeReadTagged("ArrayBuffer");
                  return function ($4) {
                      return $2(Control_Monad_Except.runExcept($3(Web_Socket_Event_MessageEvent.data_($4))));
                  };
              })();
              ...
              return function __do() {
                  var l = Web_Event_EventTarget.eventListener(function (x) {
                      return Data_Either.either(failure)(function ($7) {
                          return success(Ops_ArrayBuffer.uint8Array($7));
                      })(readEvent(x));
                  })();
  ...
  var create = function (url) {
      return function __do() {
          ...
          Web_Socket_WebSocket.setBinaryType(ws)(Web_Socket_BinaryType["ArrayBuffer"].value)();
          return ws;
      };
  };
      ...
      return function (xs) {
          ...
          if (v) {
              ...
              return Data_Array.filter((function () {
                  var $21 = Ext_String.startsWith(prefix);
                  return function ($22) {
                      return $21((function (v1) {
                          return v1.lastUpdate;
                      })($22));
                  };
              })())(xs);
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          return Control_Apply.apply(Effect.applyEffect)(Data_Functor.map(Effect.functorEffect)(function (v) {
              return function (v1) {
                  return React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-md-12") ])([ React_DOM.div([ DomOps.cn("card") ])([ React_DOM.div([ DomOps.cn("card-header") ])([ React_DOM.h4([ DomOps.cn("card-title") ])([ React_DOM.text("Nodes") ]), React_DOM.div([  ])([ React_DOM.button([ React_DOM_Props["_type"]("button"), DomOps.cn("btn btn-primary" + (function () {
                      if (v1.active) {
                          return " active";
                      };
                      return "";
                  ...
                  }) ])([ React_DOM.text("Active") ]), React_DOM.input([ React_DOM_Props["_type"]("search"), DomOps.cn("form-control"), React_DOM_Props.placeholder("Filter nodes"), React_DOM_Props.value(v1.filter), DomOps.onChangeValue(function (v2) {
      ...
      var onMsg = function ($$this) {
          return function (bytes) {
              var updateWith = function (a) {
                  ...
                  return function __do() {
                      var dt = FormatOps.dateTime(time$prime)();
