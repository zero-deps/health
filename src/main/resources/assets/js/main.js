      ...
      var render = function ($$this) {
          ...
          return function __do() {
              ...
              return React_DOM["tr'"]([ React_DOM.td([ DomOps.cn("align-top") ])([ React_DOM.text(v1.addr) ]), React_DOM.td([ DomOps.cn("align-top") ])([ React_DOM.text(DateOps.localDateTime(v1.time)) ]), React_DOM.td([ DomOps.cn("align-top") ])(Data_Functor.map(Data_Functor.functorArray)(function (y) {
                  ...
                  throw new Error("Failed pattern match at Errors (line 86, column 11 - line 92, column 50): " + [ v.expandStack.constructor.name ]);
              })() ]);
          };
      };
...
(function(exports) {
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          return function __do() {
              var v = React.getProps($$this)();
              return React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-12") ])([ React_DOM.div([ DomOps.cn("card card-chart") ])([ React_DOM.div([ DomOps.cn("card-header") ])([ React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-7 col-sm-6 text-left") ])([ React_DOM.h5([ DomOps.cn("card-category") ])([ React_DOM.text("Performance") ]), React_DOM.h2([ DomOps.cn("card-title") ])([ React_DOM.text(v.cpuLast + " / 547") ]) ]), React_DOM.div([ DomOps.cn("col-5 col-sm-6") ])([ React_DOM.div([ DomOps.cn("btn-group btn-group-toggle float-right") ])([ React_DOM.label([ DomOps.cn("btn btn-sm btn-primary btn-simple") ])([ React_DOM.span([ DomOps.cn("d-none d-sm-block d-md-block d-lg-block d-xl-block") ])([ React_DOM.text("Hour") ]), React_DOM.span([ DomOps.cn("d-block d-sm-none") ])([ React_DOM.text("H") ]) ]), React_DOM.label([ DomOps.cn("btn btn-sm btn-primary btn-simple active") ])([ React_DOM.span([ DomOps.cn("d-none d-sm-block d-md-block d-lg-block d-xl-block") ])([ React_DOM.text("Day") ]), React_DOM.span([ DomOps.cn("d-block d-sm-none") ])([ React_DOM.text("D") ]) ]), React_DOM.label([ DomOps.cn("btn btn-sm btn-primary btn-simple") ])([ React_DOM.span([ DomOps.cn("d-none d-sm-block d-md-block d-lg-block d-xl-block") ])([ React_DOM.text("Week") ]), React_DOM.span([ DomOps.cn("d-block d-sm-none") ])([ React_DOM.text("W") ]) ]) ]) ]) ]) ]), React_DOM.div([ DomOps.cn("card-body") ])([ React_DOM.div([ DomOps.cn("chart-area") ])([ React_DOM.canvas([ React_DOM_Props["_id"]("chartBig1") ])([  ]) ]) ]) ]) ]) ]);
          };
      };
      return React.component(React.reactComponentSpec()())("Node")(function ($$this) {
          return function __do() {
              ...
              return {
                  state: {},
                  render: render($$this),
                  componentDidMount: $foreign.createChart(v.cpuLoad),
                  componentDidUpdate: function (p$prime) {
                      return function (v1) {
                          return function (v2) {
                              return $foreign.updateChart(p$prime.cpuLoad);
                          };
                      };
                  }
              };
...
(function(exports) {
  ...
  var showMenu = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 36, column 1 - line 36, column 31): " + [ v.constructor.name ]);
  });
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          var menuIcon = function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 149, column 7 - line 149, column 33): " + [ v.constructor.name ]);
          };
          var $$goto = function (v) {
              if (v instanceof Nodes) {
              ...
              if (v instanceof Legacy) {
                  return DomOps.openUrl("../legacy/index.html");
              };
              throw new Error("Failed pattern match at Main (line 169, column 7 - line 169, column 34): " + [ v.constructor.name ]);
          };
          var dummy = React.component(React.reactComponentSpec()())("Dummy")(function (v) {
              return Control_Applicative.pure(Effect.applicativeEffect)({
          ...
          var menuContent = function (v) {
              if (v.menu instanceof Nodes && v.node instanceof Data_Maybe.Just) {
                  var v1 = Data_Foldable.find(Data_Foldable.foldableArray)(function (a) {
                      return a.addr === v.node.value0;
                  })(v.nodes);
                  if (v1 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 156, column 9 - line 159, column 7): " + [ v1.constructor.name ]);
              };
              ...
              if (v.menu instanceof Legacy) {
                  return Data_Functor.map(Effect.functorEffect)(function (v1) {
                      return React.createLeafElement(React.reactPropFields()())(dummy)({});
                  })(Effect_Console.error("impossible"));
              };
              throw new Error("Failed pattern match at Main (line 154, column 7 - line 154, column 50): " + [ v.constructor.name ]);
          };
          return function __do() {
              var v = React.getState($$this)();
              var v1 = React.getProps($$this)();
                  ...
                  if (v1.length === 4) {
                      return function __do() {
                          ...
                          var cpuLoad = (function () {
                              var $62 = v1[0] === "cpu.load";
                              if ($62) {
                                  return [ {
                                      t: Global.readInt(10)(v1[2]),
                                      y: Global.readInt(10)(v1[1])
                                  } ];
                              };
                              return [  ];
                          })();
                          var cpuLast = (function () {
                              var $63 = v1[0] === "cpu.load";
                              if ($63) {
                          ...
                          var nodes$prime = (function () {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Data_Maybe.fromMaybe(v2.nodes)(Data_Array.modifyAt(v3.value0)(function (b) {
                                      return {
                                          addr: v1[3],
                                          lastUpdate: v1[2],
                                          cpuLoad: Data_Semigroup.append(Data_Semigroup.semigroupArray)(b.cpuLoad)(cpuLoad),
                                          cpuLast: Data_Maybe.fromMaybe(b.cpuLast)(cpuLast)
                                      };
                                  })(v2.nodes));
                              };
                              if (v3 instanceof Data_Maybe.Nothing) {
                                  return Data_Array.snoc(v2.nodes)({
                                      addr: v1[3],
                                      lastUpdate: v1[2],
                                      cpuLoad: cpuLoad,
                              ...
                              throw new Error("Failed pattern match at Main (line 185, column 28 - line 187, column 135): " + [ v3.constructor.name ]);
                          })();
                  ...
                  if (v1.length === 4) {
                      return function __do() {
                          ...
                          var nodes$prime = (function () {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Data_Maybe.fromMaybe(v2.nodes)(Data_Array.modifyAt(v3.value0)(function (v4) {
                                      return {
                                          addr: v1[3],
                                          lastUpdate: v1[2],
                                          cpuLast: v4.cpuLast,
                              ...
                              throw new Error("Failed pattern match at Main (line 195, column 28 - line 197, column 112): " + [ v3.constructor.name ]);
                          })();
                  ...
                  if (v1.length === 3) {
                      return function __do() {
                          ...
                          var nodes$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 213, column 28 - line 215, column 112): " + [ v3.constructor.name ]);
                          })();
                          return React.modifyState($$this)(function (v3) {
                              return {
                                  menu: v3.menu,
