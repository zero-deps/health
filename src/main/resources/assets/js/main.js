...
(function($PS) {
  ...
  var byId = function (id) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at DomOps (line 30, column 3 - line 32, column 40): " + [ v1.constructor.name ]);
      };
  };
  exports["byId"] = byId;
  exports["host"] = host;
          ...
          return function __do() {
              ...
              return React_DOM.div([ DomOps.cn("wrapper" + (function () {
                  ...
                  return React_DOM.li((function () {
                      var $95 = Data_Eq.eq(eqMenu)(x)(v.menu);
                      if ($95) {
          ...
          return function (bytes) {
              var updateWith = function (a) {
                  ...
                  return function __do() {
                      ...
                      var v1 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 271, column 16 - line 278, column 34): " + [ cpu_mem.constructor.name ]);
                      })();
                      ...
                      var v2 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 284, column 15 - line 291, column 34): " + [ v2.constructor.name ]);
                      })();
                      var v3 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 293, column 15 - line 299, column 34): " + [ v3.constructor.name ]);
                      })();
                      var v4 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 301, column 16 - line 310, column 34): " + [ v4.constructor.name ]);
                      })();
                      ...
                      var node$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 334, column 21 - line 432, column 18): " + [ v6.constructor.name ]);
                      })();
                      ...
                      throw new Error("Failed pattern match at Main (line 434, column 9 - line 436, column 31): " + [ a.err.constructor.name ]);
                  };
              };
              ...
              if (v instanceof Data_Either.Right && (v.value0.val instanceof Push.StatPush && v.value0.val.value0.stat instanceof Push.MetricStat)) {
                  var cpu_mem = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                      var $135 = v.value0.val.value0.stat.value0.name === "cpu_mem";
                      if ($135) {
                  ...
                  var cpu_hour = (function () {
                      var $136 = v.value0.val.value0.stat.value0.name === "cpu.hour";
                      if ($136) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var uptime = (function () {
                      var $137 = v.value0.val.value0.stat.value0.name === "uptime";
                      if ($137) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var version = (function () {
                      var $138 = v.value0.val.value0.stat.value0.name === "v";
                      if ($138) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var fs = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                      var $139 = v.value0.val.value0.stat.value0.name === "fs./";
                      if ($139) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var fd = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                      var $140 = v.value0.val.value0.stat.value0.name === "fd";
                      if ($140) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var thr = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                      var $141 = v.value0.val.value0.stat.value0.name === "thr";
                      if ($141) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var kvsSize_year = (function () {
                      var $142 = v.value0.val.value0.stat.value0.name === "kvs.size.year";
                      if ($142) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
              ...
              if (v instanceof Data_Either.Right && (v.value0.val instanceof Push.StatPush && v.value0.val.value0.stat instanceof Push.MeasureStat)) {
                  ...
                  var staticCreate = (function () {
                      var $156 = v.value0.val.value0.stat.value0.name === "static.create";
                      if ($156) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticCreate_thirdQ = (function () {
                      var $157 = v.value0.val.value0.stat.value0.name === "static.create.thirdQ";
                      if ($157) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticCreate_year = (function () {
                      var $158 = v.value0.val.value0.stat.value0.name === "static.create.year";
                      if ($158) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticGen = (function () {
                      var $159 = v.value0.val.value0.stat.value0.name === "static.gen";
                      if ($159) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticGen_thirdQ = (function () {
                      var $160 = v.value0.val.value0.stat.value0.name === "static.gen.thirdQ";
                      if ($160) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticGen_year = (function () {
                      var $161 = v.value0.val.value0.stat.value0.name === "static.gen.year";
                      if ($161) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexTs = (function () {
                      var $162 = v.value0.val.value0.stat.value0.name === "reindex.ts";
                      if ($162) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexTs_thirdQ = (function () {
                      var $163 = v.value0.val.value0.stat.value0.name === "reindex.ts.thirdQ";
                      if ($163) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexWc = (function () {
                      var $164 = v.value0.val.value0.stat.value0.name === "reindex.wc";
                      if ($164) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexWc_thirdQ = (function () {
                      var $165 = v.value0.val.value0.stat.value0.name === "reindex.wc.thirdQ";
                      if ($165) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexFiles = (function () {
                      var $166 = v.value0.val.value0.stat.value0.name === "reindex.files";
                      if ($166) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexFiles_thirdQ = (function () {
                      var $167 = v.value0.val.value0.stat.value0.name === "reindex.files.thirdQ";
                      if ($167) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
