...
(function(exports) {
  // Generated by purs version 0.12.2
  "use strict";
  var $foreign = PS["Proto"];
  var Data_ArrayBuffer_Types = PS["Data.ArrayBuffer.Types"];
  var Effect = PS["Effect"];
  var Prelude = PS["Prelude"];
  exports["createReader"] = $foreign.createReader;
  exports["pos"] = $foreign.pos;
  exports["uint32"] = $foreign.uint32;
  exports["string"] = $foreign.string;
  exports["skipType"] = $foreign.skipType;
})(PS["Proto"] = PS["Proto"] || {});
(function(exports) {
  // Generated by purs version 0.12.2
  "use strict";
  ...
  var decodeMetricStat = function (reader) {
      return function (msglen) {
          var decode = function (end) {
              return function (acc) {
                  var $50 = Proto.pos(reader) < end;
                  if ($50) {
                      return function __do() {
                          var v = Proto.uint32(reader)();
                          var v1 = v >>> 3;
                          if (v1 === 1) {
                              var v2 = Proto.string(reader)();
                              return decode(end)({
                                  name: v2,
                                  value: acc.value,
                                  time: acc.time,
                          ...
                          Proto.skipType(reader)(v & 7)();
                          return decode(end)(acc)();
                      };
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(acc);
              };
          };
          var end = Proto.pos(reader) + msglen | 0;
          return decode(end)({
              name: "",
              value: "",
              time: "",
  ...
  var decodeMeasureStat = function (reader) {
      return function (msglen) {
          var decode = function (end) {
              return function (acc) {
                  var $57 = Proto.pos(reader) < end;
                  if ($57) {
                      return function __do() {
                          var v = Proto.uint32(reader)();
                          var v1 = v >>> 3;
  ...
  var decodeErrorStat = function (reader) {
      return function (msglen) {
          var decode = function (end) {
              return function (acc) {
                  var $64 = Proto.pos(reader) < end;
                  if ($64) {
                      return function __do() {
                          var v = Proto.uint32(reader)();
                          var v1 = v >>> 3;
  ...
  var decodeActionStat = function (reader) {
      return function (msglen) {
          var decode = function (end) {
              return function (acc) {
                  var $72 = Proto.pos(reader) < end;
                  if ($72) {
                      return function __do() {
                          var v = Proto.uint32(reader)();
                          var v1 = v >>> 3;
  ...
  var decodeStatMsg = function (bytes) {
      var reader = Proto.createReader(bytes);
      return function __do() {
          var v = Proto.uint32(reader)();
          var v1 = v >>> 3;
          if (v1 === 1) {
              var v2 = Proto.uint32(reader)();
              var v3 = decodeMetricStat(reader)(v2)();
              return Data_Maybe.Just.create(new MetricStat(v3));
          };
          if (v1 === 2) {
              var v2 = Proto.uint32(reader)();
              var v3 = decodeMeasureStat(reader)(v2)();
              return Data_Maybe.Just.create(new MeasureStat(v3));
          };
          if (v1 === 3) {
              var v2 = Proto.uint32(reader)();
              var v3 = decodeErrorStat(reader)(v2)();
              return Data_Maybe.Just.create(new ErrorStat(v3));
          };
          if (v1 === 4) {
              var v2 = Proto.uint32(reader)();
              var v3 = decodeActionStat(reader)(v2)();
              return Data_Maybe.Just.create(new ActionStat(v3));
          };
      ...
      return function __do() {
          ...
          return {
                  ...
                  return function (v2) {
                      return function (v3) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at BarChart (line 37, column 9 - line 40, column 5): " + [ v4.constructor.name ]);
                          };
                      };
                  };
              },
              componentWillUnmount: function __do() {
                  ...
                  throw new Error("Failed pattern match at BarChart (line 42, column 9 - line 47, column 5): " + [ v2.constructor.name ]);
              }
          };
      };
  });
      ...
      return function __do() {
          ...
          return {
                  ...
                  return function (v2) {
                      return function (v3) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at BigChart (line 40, column 9 - line 43, column 5): " + [ v4.constructor.name ]);
                          };
                      };
                  };
              },
              componentWillUnmount: function __do() {
                  ...
                  throw new Error("Failed pattern match at BigChart (line 45, column 9 - line 50, column 5): " + [ v2.constructor.name ]);
              }
          };
      };
  });
      ...
      return function __do() {
          ...
          return {
                  ...
                  return function (v2) {
                      return function (v3) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at CpuChart (line 37, column 9 - line 40, column 5): " + [ v4.constructor.name ]);
                          };
                      };
                  };
              },
              componentWillUnmount: function __do() {
                  ...
                  throw new Error("Failed pattern match at CpuChart (line 42, column 9 - line 47, column 5): " + [ v2.constructor.name ]);
              }
          };
      };
  });
      ...
      return function __do() {
          ...
          return {
                  ...
                  return function (v2) {
                      return function (v3) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at YearChart (line 38, column 9 - line 41, column 5): " + [ v4.constructor.name ]);
                          };
                      };
                  };
              },
              componentWillUnmount: function __do() {
                  ...
                  throw new Error("Failed pattern match at YearChart (line 43, column 9 - line 48, column 5): " + [ v2.constructor.name ]);
              }
          };
      };
  });
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM["div'"]([ React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-12") ])([ React_DOM.div([ DomOps.cn("card card-chart") ])([ React_DOM.div([ DomOps.cn("card-header") ])([ React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-7 col-sm-6 text-left") ])([ React_DOM.h5([ DomOps.cn("card-category") ])([ React_DOM.text("Performance") ]), React_DOM.h2([ DomOps.cn("card-title") ])([ React_DOM.i([ DomOps.cn("tim-icons icon-spaceship text-primary") ])([  ]), React_DOM.text(" " + (Data_Maybe.fromMaybe("--")(v.cpuLast) + ("% / " + (Data_Maybe.fromMaybe("--")(Data_Functor.map(Data_Maybe.functorMaybe)(FormatOps.formatNum)(v.memLast)) + " MB")))) ]) ]), React_DOM.div([ DomOps.cn("col-5 col-sm-6") ])([ React_DOM.div([ DomOps.cn("btn-group btn-group-toggle float-right") ])([ React_DOM.label([ DomOps.cn("btn btn-sm btn-primary btn-simple" + (function () {
                  var $15 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Live.value);
                  if ($15) {
                      return " active";
                  };
                  return "";
                  ...
                  var $16 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Hour.value);
                  if ($16) {
                      return " active";
                  };
                  return "";
                  ...
                  var $17 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Live.value);
                  if ($17) {
                      return "";
                  };
                  return " d-none";
                  ...
                  var $18 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Hour.value);
                  if ($18) {
                      return "";
                  };
                  return " d-none";
              ...
              }) ]) ]) ]) ]) ]), React_DOM.div([ DomOps.cn("row") ])([ barChart("Translations: Search")(v.searchTs_thirdQ)(v.searchTs_points), barChart("Web Contents: Search")(v.searchWc_thirdQ)(v.searchWc_points), barChart("Static: Creation")(v.staticCreate_thirdQ)(v.staticCreate_points), barChart("Static: Generation")(v.staticGen_thirdQ)(v.staticGen_points) ]), React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-12") ])([ React_DOM.div([ DomOps.cn("card card-chart") ])([ React_DOM.div([ DomOps.cn("card-header") ])([ React_DOM.h5([ DomOps.cn("card-category") ])([ React_DOM.text("Static: Creation") ]) ]), React_DOM.div([ DomOps.cn("card-body") ])([ React_DOM.div([ DomOps.cn("chart-area") ])([ React.createLeafElement(React.reactPropFields()())(YearChart.reactClass)({
...
(function(exports) {
  ...
  var printBinaryType = function (v) {
      ...
      throw new Error("Failed pattern match at Web.Socket.BinaryType (line 46, column 3 - line 48, column 20): " + [ v.constructor.name ]);
  };
  exports["Blob"] = Blob;
...
(function(exports) {
  ...
  var setBinaryType = function (ws) {
      return function ($12) {
          return $foreign.setBinaryTypeImpl(ws)(Web_Socket_BinaryType.printBinaryType($12));
      };
  };
  ...
  var onMsg = function (ws) {
      return function (success) {
          return function (failure) {
              ...
              var bytes = function ($7) {
                  return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function ($8) {
                      return Data_Functor.map(Data_List_Types.functorList)(Foreign.renderForeignError)(Data_List_NonEmpty.toList($8));
                  })(Control_Monad_Except.runExcept(Foreign.unsafeReadTagged("ArrayBuffer")(Web_Socket_Event_MessageEvent.data_($7))));
              };
              ...
              return function __do() {
                  var v = Web_Event_EventTarget.eventListener(function (x) {
                      return Data_Either.either(failure)(function ($9) {
                          return success(Ops_ArrayBuffer.uint8Array($9));
                      })(readEvent(x));
                  })();
...
(function(exports) {
  ...
  var showMenu = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 50, column 1 - line 50, column 31): " + [ v.constructor.name ]);
  });
      ...
      var render = function ($$this) {
          ...
          var menuContent = function (v) {
              if (v.menu instanceof Nodes && v.node instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 163, column 9 - line 166, column 9): " + [ v1.constructor.name ]);
              };
          ...
          var $$goto = function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 174, column 7 - line 174, column 34): " + [ v.constructor.name ]);
          };
          return function __do() {
              var v = React.getState($$this)();
              var v1 = React.getProps($$this)();
              ...
              return React_DOM.div([ DomOps.cn("wrapper" + (function () {
                  ...
                  return React_DOM.li((function () {
                      var $87 = Data_Eq.eq(eqMenu)(x)(v.menu);
                      if ($87) {
              ...
              var updateWith = function (a) {
                  ...
                  return function __do() {
                      ...
                      var v1 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 263, column 16 - line 270, column 34): " + [ cpu_mem.constructor.name ]);
                      })();
                      ...
                      var v2 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 276, column 15 - line 283, column 34): " + [ v2.constructor.name ]);
                      })();
                      var v3 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 285, column 15 - line 291, column 34): " + [ v3.constructor.name ]);
                      })();
                      var v4 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 293, column 16 - line 302, column 34): " + [ v4.constructor.name ]);
                      })();
                      ...
                      var node$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 321, column 21 - line 403, column 18): " + [ v6.constructor.name ]);
                      })();
                      ...
                      throw new Error("Failed pattern match at Main (line 405, column 9 - line 407, column 31): " + [ a.err.constructor.name ]);
                  };
              };
              return function __do() {
                  var v = Api.decodeStatMsg(bytes)();
                  if (v instanceof Data_Maybe.Just && v.value0 instanceof Api.MetricStat) {
                      var cpu_mem = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $128 = v.value0.value0.name === "cpu_mem";
                          if ($128) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      })());
                      var cpu_hour = (function () {
                          var $129 = v.value0.value0.name === "cpu.hour";
                          if ($129) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var uptime = (function () {
                          var $130 = v.value0.value0.name === "uptime";
                          if ($130) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var version = (function () {
                          var $131 = v.value0.value0.name === "v";
                          if ($131) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var fs = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $132 = v.value0.value0.name === "fs./";
                          if ($132) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var fd = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $133 = v.value0.value0.name === "fd";
                          if ($133) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var thr = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split("~"))((function () {
                          var $134 = v.value0.value0.name === "thr";
                          if ($134) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var kvsSize_year = (function () {
                          var $135 = v.value0.value0.name === "kvs.size.year";
                          if ($135) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      return updateWith({
                          addr: v.value0.value0.addr,
                          time: v.value0.value0.time,
                  ...
                  if (v instanceof Data_Maybe.Just && v.value0 instanceof Api.MeasureStat) {
                      var value$prime = Global.readInt(10)(v.value0.value0.value);
                      var searchTs = (function () {
                          var $142 = v.value0.value0.name === "search.ts";
                          if ($142) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var searchTs_thirdQ = (function () {
                          var $143 = v.value0.value0.name === "search.ts.thirdQ";
                          if ($143) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var searchWc = (function () {
                          var $144 = v.value0.value0.name === "search.wc";
                          if ($144) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var searchWc_thirdQ = (function () {
                          var $145 = v.value0.value0.name === "search.wc.thirdQ";
                          if ($145) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticCreate = (function () {
                          var $146 = v.value0.value0.name === "static.create";
                          if ($146) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticCreate_thirdQ = (function () {
                          var $147 = v.value0.value0.name === "static.create.thirdQ";
                          if ($147) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticCreate_year = (function () {
                          var $148 = v.value0.value0.name === "static.create.year";
                          if ($148) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticGen = (function () {
                          var $149 = v.value0.value0.name === "static.gen";
                          if ($149) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticGen_thirdQ = (function () {
                          var $150 = v.value0.value0.name === "static.gen.thirdQ";
                          if ($150) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var staticGen_year = (function () {
                          var $151 = v.value0.value0.name === "static.gen.year";
                          if ($151) {
                              return new Data_Maybe.Just(v.value0.value0.value);
                          };
                          return Data_Maybe.Nothing.value;
                  ...
                  if (v instanceof Data_Maybe.Just && v.value0 instanceof Api.ErrorStat) {
                      var exception = Data_String_Common.split("~")(v.value0.value0.exception);
                      var stacktrace = Data_String_Common.split("~")(v.value0.value0.stacktrace);
                      var key = v.value0.value0.addr + v.value0.value0.time;
                      var err = {
                          exception: exception,
                          stacktrace: stacktrace,
                          toptrace: v.value0.value0.toptrace,
                          time: v.value0.value0.time,
                          addr: v.value0.value0.addr,
                          key: key
                      };
                  ...
                  if (v instanceof Data_Maybe.Just && v.value0 instanceof Api.ActionStat) {
                      return updateWith({
                          addr: v.value0.value0.addr,
                          time: v.value0.value0.time,
                          metrics: Data_Maybe.Nothing.value,
                          measure: Data_Maybe.Nothing.value,
                          err: Data_Maybe.Nothing.value,
                          action: new Data_Maybe.Just(v.value0.value0.action)
                      })();
                  };
