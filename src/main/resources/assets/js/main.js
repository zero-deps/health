      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM["div'"]([ React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-12") ])([ React_DOM.div([ DomOps.cn("card card-chart") ])([ React_DOM.div([ DomOps.cn("card-header") ])([ React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-7 col-sm-6 text-left") ])([ React_DOM.h5([ DomOps.cn("card-category") ])([ React_DOM.text("Performance") ]), React_DOM.h2([ DomOps.cn("card-title") ])([ React_DOM.i([ DomOps.cn("tim-icons icon-spaceship text-primary") ])([  ]), React_DOM.text(" " + (Data_Maybe.fromMaybe("--")(v.cpuLast) + ("% / " + (Data_Maybe.fromMaybe("--")(Data_Functor.map(Data_Maybe.functorMaybe)(FormatOps.formatNum)(v.memLast)) + " MB")))) ]) ]), React_DOM.div([ DomOps.cn("col-5 col-sm-6") ])([ React_DOM.div([ DomOps.cn("btn-group btn-group-toggle float-right") ])([ React_DOM.label([ DomOps.cn("btn btn-sm btn-primary btn-simple" + (function () {
                  var $34 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Live.value);
                  if ($34) {
                      return " active";
                  };
                  return "";
                  ...
                  var $35 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Hour.value);
                  if ($35) {
                      return " active";
                  };
                  return "";
                  ...
                  var $36 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Live.value);
                  if ($36) {
                      return "";
                  };
                  return " d-none";
                  ...
                  var $37 = Data_Eq.eq(Schema.eqChartRange)(v1.bigChartRange)(Schema.Hour.value);
                  if ($37) {
                      return "";
                  };
                  return " d-none";
                  ...
                  var thirdQ = (function () {
                      ...
                      throw new Error("Failed pattern match at Node (line 94, column 22 - line 97, column 52): " + [ v1.reindexChart.constructor.name ]);
                  })();
                  return React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-12") ])([ React_DOM.div([ DomOps.cn("card card-chart") ])([ React_DOM.div([ DomOps.cn("card-header") ])([ React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-7 col-sm-6 text-left") ])([ React_DOM.h5([ DomOps.cn("card-category") ])([ React_DOM.text("Reindex") ]), React_DOM.h2([ DomOps.cn("card-title") ])([ React_DOM.i([ DomOps.cn("tim-icons icon-user-run text-info") ])([  ]), React_DOM.text(Data_Maybe.fromMaybe("--")(Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                      ...
                      var $39 = Data_Eq.eq(Schema.eqReindexChart)(v1.reindexChart)(Schema.TsReindex.value);
                      if ($39) {
                          return " active";
                      };
                      return "";
                  })()), React_DOM_Props.onClick(function (v2) {
                      return React.modifyStateWithCallback($$this)(function (v3) {
                          return {
                      ...
                      var $40 = Data_Eq.eq(Schema.eqReindexChart)(v1.reindexChart)(Schema.WcReindex.value);
                      if ($40) {
                          return " active";
                      };
                      return "";
                      ...
                      var $41 = Data_Eq.eq(Schema.eqReindexChart)(v1.reindexChart)(Schema.FilesReindex.value);
                      if ($41) {
                          return " active";
                      };
                      return "";
                  ...
                  }) ])([ React_DOM.span([ DomOps.cn("d-none d-sm-block d-md-block d-lg-block d-xl-block") ])([ React_DOM.text("Files") ]), React_DOM.span([ DomOps.cn("d-block d-sm-none") ])([ React_DOM.text("Fs") ]) ]) ]) ]) ]) ]), React_DOM.div([ DomOps.cn("card-body") ])([ React_DOM.div([ DomOps.cn("chart-area") ])([ React.createLeafElement(React.reactPropFields()())(MeasureChart.reactClass)((function () {
                      if (v1.reindexChart instanceof Schema.TsReindex) {
                          return {
                      ...
                      throw new Error("Failed pattern match at Node (line 143, column 64 - line 146, column 118): " + [ v1.reindexChart.constructor.name ]);
                  })()) ]) ]) ]) ]) ]);
                  ...
                  var $43 = Data_Eq.eq(Schema.eqStaticChart)(v1.staticChart)(Schema.Creation.value);
                  if ($43) {
                      return " active";
                  };
                  return "";
                  ...
                  var $44 = Data_Eq.eq(Schema.eqStaticChart)(v1.staticChart)(Schema.Generation.value);
                  if ($44) {
                      return " active";
                  };
                  return "";
              ...
              }) ])([ React_DOM.span([ DomOps.cn("d-none d-sm-block d-md-block d-lg-block d-xl-block") ])([ React_DOM.text("Generation") ]), React_DOM.span([ DomOps.cn("d-block d-sm-none") ])([ React_DOM.text("Gen") ]) ]) ]) ]) ]) ]), React_DOM.div([ DomOps.cn("card-body") ])([ React_DOM.div([ DomOps.cn("chart-area") ])([ React.createLeafElement(React.reactPropFields()())(YearChart.reactClass)((function () {
                  if (v1.staticChart instanceof Schema.Creation) {
                      return {
                          points: v.staticCreateYear_points,
                          label: "ms"
                      };
                  };
                  if (v1.staticChart instanceof Schema.Generation) {
                      return {
                          points: v.staticGenYear_points,
                          label: "ms"
                      };
                  };
                  throw new Error("Failed pattern match at Node (line 185, column 60 - line 187, column 82): " + [ v1.staticChart.constructor.name ]);
              ...
              }), React_DOM_Props.value(v1.feature) ])([ React_DOM.option([ React_DOM_Props.value("disabled-users") ])([ React_DOM.text("Disabled users") ]), React_DOM.option([ React_DOM_Props.value("wc-flow") ])([ React_DOM.text("Webcontents flow") ]) ]) ]) ]) ]) ]), React_DOM.div([ DomOps.cn("card-body") ])([ React_DOM.div([ DomOps.cn("chart-area") ])([ React.createLeafElement(React.reactPropFields()())(YearChart.reactClass)({
                  points: Data_Maybe.fromMaybe([  ])(Data_Map_Internal.lookup(Data_Ord.ordString)(v1.feature)(v.features)),
                  label: ""
...
(function($PS) {
  ...
  var uint32 = (function () {
      ...
      var $5 = loop([  ]);
      return function ($6) {
          return Proto_Uint8ArrayExt.fromArray($5($6));
      };
  })();
...
(function($PS) {
  ...
  var encodePull = function (v) {
      return Proto_Uint8ArrayExt.concatAll([ Proto_Encode.uint32(82), encodeNodeRemove(v.value0) ]);
  };
  exports["NodeRemove"] = NodeRemove;
  exports["encodePull"] = encodePull;
  exports["encodeNodeRemove"] = encodeNodeRemove;
})(PS);
(function(exports) {
  "use strict"
...
(function($PS) {
  ...
  var sendB = Web_Socket_WebSocket.sendArrayBufferView;
...
(function($PS) {
  ...
  var NodeRemoveOk = (function () {
      ...
      NodeRemoveOk.create = function (value0) {
          return new NodeRemoveOk(value0);
      };
      return NodeRemoveOk;
  })();
  var NodeRemoveErr = (function () {
      function NodeRemoveErr(value0) {
          this.value0 = value0;
      };
      NodeRemoveErr.create = function (value0) {
          return new NodeRemoveErr(value0);
      };
      ...
      return function (pos0) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.uint32(_xs_)(pos0))(function (v) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(decode(end)({
                  ...
                  return Data_Either.Left.create(new Proto_Decode.MissingFields("NodeRemoveOk"));
              });
          });
      };
  };
  var decodeNodeRemoveErr = function (_xs_) {
      return function (pos0) {
          var decode = function ($copy_end) {
              return function ($copy_acc) {
                  return function ($copy_pos1) {
                              ...
                              if (v instanceof Data_Either.Right) {
                                  ...
                                  if (v1 === 2) {
                                      ...
                                      if (v2 instanceof Data_Either.Right) {
                                          ...
                                          $tco_var_acc = {
                                              addr: acc.addr,
                                              msg: new Data_Maybe.Just(v2.value0.val)
                                          };
                                          $copy_pos1 = v2.value0.pos;
                                          return;
                                      };
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.uint32(_xs_)(pos0))(function (v) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(decode(end)({
                  ...
                  if (v1.val.addr instanceof Data_Maybe.Just && v1.val.msg instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
                              addr: v1.val.addr.value0,
                              msg: v1.val.msg.value0
                          }
                      });
                  };
                  return Data_Either.Left.create(new Proto_Decode.MissingFields("NodeRemoveErr"));
              });
          });
      };
  };
  ...
  var decodeStat = function (_xs_) {
      return function (pos0) {
          var decode = function ($copy_end) {
              return function ($copy_v) {
                  return function ($copy_pos1) {
                      ...
                      var $tco_done = false;
                      var $tco_result;
                      function $tco_loop(end, v, pos1) {
                          if (pos1 < end) {
                              var v1 = Proto_Decode.uint32(_xs_)(pos1);
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.uint32(_xs_)(pos0))(function (v) {
              var end = v.pos + v.val | 0;
              return decode(end)(Data_Maybe.Nothing.value)(v.pos);
          });
      };
  };
  ...
  var decodePush = function (_xs_) {
      return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.uint32(_xs_)(0))(function (v) {
          ...
          if (v1 === 10) {
              return Control_Bind.bind(Data_Either.bindEither)(decodeNodeRemoveOk(_xs_)(v.pos))(function (v2) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                      pos: v2.pos,
                      val: new NodeRemoveOk(v2.val)
                  });
              });
          };
          if (v1 === 11) {
              return Control_Bind.bind(Data_Either.bindEither)(decodeNodeRemoveErr(_xs_)(v.pos))(function (v2) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                      pos: v2.pos,
                      val: new NodeRemoveErr(v2.val)
                  });
              });
          };
...
(function($PS) {
  ...
  var showMenu = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 53, column 1 - line 55, column 25): " + [ v.constructor.name ]);
  });
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          ...
          var menuIcon = function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 161, column 7 - line 161, column 33): " + [ v.constructor.name ]);
          };
          var $$goto = function (v) {
              if (v instanceof Nodes) {
          ...
          var filterNodes = function (v) {
              return function (nodes) {
                  if (Data_String_CodePoints.length(v) < 3) {
                      return nodes;
                  };
          ...
          var menuContent = function (v) {
              if (v.menu instanceof Nodes && v.node instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 167, column 9 - line 169, column 79): " + [ v1.constructor.name ]);
              };
          ...
          return function __do() {
              ...
              return React_DOM.div([ DomOps.cn("wrapper" + (function () {
                  ...
                  return React_DOM.li((function () {
                      var $103 = Data_Eq.eq(eqMenu)(x)(v.menu);
                      if ($103) {
          ...
          return function (bytes) {
              var updateWith = function (a) {
                  ...
                  return function __do() {
                      ...
                      var featurePoint = Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(a.metrics)(function (v1) {
                          return v1.feature;
                      }))(function (v1) {
                          var v3 = Data_String_Common.split("~")(v1);
                          if (v3.length === 2) {
                              return new Data_Maybe.Just({
                                  name: v3[0],
                                  point: {
                                      t: time$prime,
                                      y: Global.readInt(10)(v3[1])
                                  }
                              });
                          };
                          return Data_Maybe.Nothing.value;
                      ...
                      var v1 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 294, column 16 - line 302, column 34): " + [ cpu_mem.constructor.name ]);
                      })();
                      ...
                      var v2 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 308, column 15 - line 315, column 34): " + [ v2.constructor.name ]);
                      })();
                      var v3 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 317, column 15 - line 323, column 34): " + [ v3.constructor.name ]);
                      })();
                      var v4 = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 325, column 16 - line 334, column 34): " + [ v4.constructor.name ]);
                      })();
                      ...
                      var node$prime = (function () {
                          ...
                          if (v6 instanceof Data_Maybe.Just) {
                              ...
                              var features$prime = Data_Maybe.maybe(v6.value0.features)(function (x) {
                                  var points$prime = (function () {
                                      var v7 = Data_Map_Internal.lookup(Data_Ord.ordString)(x.name)(v6.value0.features);
                                      if (v7 instanceof Data_Maybe.Just) {
                                          return Data_Array.snoc(v7.value0)(x.point);
                                      };
                                      if (v7 instanceof Data_Maybe.Nothing) {
                                          return Data_Array.singleton(x.point);
                                      };
                                      throw new Error("Failed pattern match at Main (line 388, column 47 - line 390, column 67): " + [ v7.constructor.name ]);
                                  })();
                                  return Data_Map_Internal.insert(Data_Ord.ordString)(x.name)(points$prime)(v6.value0.features);
                              })(featurePoint);
                          ...
                          throw new Error("Failed pattern match at Main (line 358, column 21 - line 467, column 18): " + [ v6.constructor.name ]);
                      })();
                      ...
                      throw new Error("Failed pattern match at Main (line 469, column 9 - line 471, column 31): " + [ a.err.constructor.name ]);
                  };
              };
              ...
              if (v instanceof Data_Either.Right && (v.value0.val instanceof Push.StatMsg && v.value0.val.value0.stat instanceof Push.Measure)) {
                  ...
                  var staticCreate = (function () {
                      var $174 = v.value0.val.value0.stat.value0.name === "static.create";
                      if ($174) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticCreate_thirdQ = (function () {
                      var $175 = v.value0.val.value0.stat.value0.name === "static.create.thirdQ";
                      if ($175) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticCreate_year = (function () {
                      var $176 = v.value0.val.value0.stat.value0.name === "static.create.year";
                      if ($176) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticGen = (function () {
                      var $177 = v.value0.val.value0.stat.value0.name === "static.gen";
                      if ($177) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticGen_thirdQ = (function () {
                      var $178 = v.value0.val.value0.stat.value0.name === "static.gen.thirdQ";
                      if ($178) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var staticGen_year = (function () {
                      var $179 = v.value0.val.value0.stat.value0.name === "static.gen.year";
                      if ($179) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexTs = (function () {
                      var $180 = v.value0.val.value0.stat.value0.name === "reindex.ts";
                      if ($180) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexTs_thirdQ = (function () {
                      var $181 = v.value0.val.value0.stat.value0.name === "reindex.ts.thirdQ";
                      if ($181) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexWc = (function () {
                      var $182 = v.value0.val.value0.stat.value0.name === "reindex.wc";
                      if ($182) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexWc_thirdQ = (function () {
                      var $183 = v.value0.val.value0.stat.value0.name === "reindex.wc.thirdQ";
                      if ($183) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexFiles = (function () {
                      var $184 = v.value0.val.value0.stat.value0.name === "reindex.files";
                      if ($184) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
                  ...
                  var reindexFiles_thirdQ = (function () {
                      var $185 = v.value0.val.value0.stat.value0.name === "reindex.files.thirdQ";
                      if ($185) {
                          return new Data_Maybe.Just(v.value0.val.value0.stat.value0.value);
                      };
                      return Data_Maybe.Nothing.value;
