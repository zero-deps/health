...
(function(exports) {
  ...
  var byId = function (id) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at DomOps (line 22, column 3 - line 24, column 40): " + [ v1.constructor.name ]);
      };
  };
  exports["byId"] = byId;
  exports["host"] = host;
...
(function(exports) {
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([ React_DOM_Props.className("wrapper") ])([ React_DOM.div([ React_DOM_Props.className("sidebar") ])([ React_DOM.div([ React_DOM_Props.className("sidebar-wrapper") ])([ React_DOM.ul([ React_DOM_Props.className("nav") ])([ React_DOM.li([ React_DOM_Props.className("active") ])([ React_DOM.a([ React_DOM_Props.href("#") ])([ React_DOM.i([ React_DOM_Props.className("tim-icons icon-app") ])([  ]), React_DOM["p'"]([ React_DOM.text("Nodes") ]) ]) ]), React_DOM.li([  ])([ React_DOM.a([ React_DOM_Props.href("#") ])([ React_DOM.i([ React_DOM_Props.className("tim-icons icon-alert-circle-exc") ])([  ]), React_DOM["p'"]([ React_DOM.text("Errors") ]) ]) ]), React_DOM.li([  ])([ React_DOM.a([ React_DOM_Props.href("monitor.html") ])([ React_DOM.i([ React_DOM_Props.className("tim-icons icon-compass-05") ])([  ]), React_DOM["p'"]([ React_DOM.text("Legacy") ]) ]) ]) ]) ]) ]), React_DOM.div([ React_DOM_Props.className("main-panel") ])([ React_DOM.nav([ React_DOM_Props.className("navbar navbar-expand-lg navbar-absolute navbar-transparent") ])([ React_DOM.div([ React_DOM_Props.className("container-fluid") ])([ React_DOM.div([ React_DOM_Props.className("navbar-wrapper") ])([ React_DOM.div([ React_DOM_Props.className("navbar-toggle d-inline") ])([ React_DOM.button([ React_DOM_Props.className("navbar-toggler") ])([ React_DOM.span([ React_DOM_Props.className("navbar-toggler-bar bar1") ])([  ]), React_DOM.span([ React_DOM_Props.className("navbar-toggler-bar bar2") ])([  ]), React_DOM.span([ React_DOM_Props.className("navbar-toggler-bar bar3") ])([  ]) ]) ]), React_DOM.a([ React_DOM_Props.href(""), React_DOM_Props.className("navbar-brand") ])([ React_DOM.text("Monitor") ]) ]), React_DOM.button([ React_DOM_Props.className("navbar-toggler") ])([ React_DOM.span([ React_DOM_Props.className("navbar-toggler-bar navbar-kebab") ])([  ]), React_DOM.span([ React_DOM_Props.className("navbar-toggler-bar navbar-kebab") ])([  ]), React_DOM.span([ React_DOM_Props.className("navbar-toggler-bar navbar-kebab") ])([  ]) ]), React_DOM.div([ React_DOM_Props.className("collapse navbar-collapse") ])([ React_DOM.ul([ React_DOM_Props.className("navbar-nav ml-auto") ])([ React_DOM.li([ React_DOM_Props.className("dropdown nav-item") ])([ React_DOM.a([ React_DOM_Props.href("#"), React_DOM_Props.className("dropdown-toggle nav-link") ])([ React_DOM.div([ React_DOM_Props.className("notification d-none d-lg-block d-xl-block") ])([  ]), React_DOM.i([ React_DOM_Props.className("tim-icons icon-sound-wave") ])([  ]), React_DOM.p([ React_DOM_Props.className("d-lg-none") ])([ React_DOM.text("Notifications") ]) ]), React_DOM.ul([ React_DOM_Props.className("dropdown-menu dropdown-menu-right dropdown-navbar") ])([ React_DOM.li([ React_DOM_Props.className("nav-link") ])([ React_DOM.a([ React_DOM_Props.href("#"), React_DOM_Props.className("nav-item dropdown-item") ])([ React_DOM.text("No notifications") ]) ]) ]) ]), React_DOM.li([ React_DOM_Props.className("separator d-lg-none") ])([  ]) ]) ]) ]) ]), React_DOM.div([ React_DOM_Props.className("content") ])([ React_DOM.div([ React_DOM_Props.className("row") ])([ React_DOM.div([ React_DOM_Props.className("col-md-12") ])([ React_DOM.div([ React_DOM_Props.className("card") ])([ React_DOM.div([ React_DOM_Props.className("card-header") ])([ React_DOM.h4([ React_DOM_Props.className("card-title") ])([ React_DOM.text("Nodes") ]) ]), React_DOM.div([ React_DOM_Props.className("card-body") ])([ React_DOM.div([ React_DOM_Props.className("table-responsive") ])([ React_DOM.table([ React_DOM_Props.className("table tablesorter") ])([ React_DOM.thead([ React_DOM_Props.className("text-primary") ])([ React_DOM["tr'"]([ React_DOM["th'"]([ React_DOM.text("System") ]), React_DOM["th'"]([ React_DOM.text("Address") ]), React_DOM["th'"]([ React_DOM.text("Last Update") ]) ]) ]), React_DOM["tbody'"](Data_Functor.map(Data_Functor.functorArray)(function (x) {
                  return React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text(x.sys) ]), React_DOM["td'"]([ React_DOM.text(x.addr) ]), React_DOM["td'"]([ React_DOM.text(DateOps.localDateTime(x.lastUpdate)) ]) ]);
              })(v.nodes)) ]) ]) ]) ]) ]) ]) ]), React_DOM.div([ React_DOM_Props.className("footer") ])([ React_DOM.div([ React_DOM_Props.className("container-fluid") ])([ React_DOM.ul([ React_DOM_Props.className("nav") ])([ React_DOM.li([ React_DOM_Props.className("nav-item") ])([ React_DOM.a([ React_DOM_Props.href("http://ua--doc.ee..corp"), React_DOM_Props.className("nav-link") ])([ React_DOM.text("Documentation") ]) ]) ]), React_DOM.div([ React_DOM_Props.className("copyright") ])([ React_DOM.text("\xa9 2019 "), React_DOM.a([ React_DOM_Props.href("https://demos.creative-tim.com/black-dashboard/examples/dashboard.html"), React_DOM_Props.target("_blank") ])([ React_DOM.text("CT") ]) ]) ]) ]) ]) ]);
          };
      };
                  ...
                  if (v1.length === 5) {
                      return function __do() {
                          ...
                          var nodes$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 184, column 28 - line 186, column 49): " + [ v3.constructor.name ]);
                          })();
  ...
  var view = function __do() {
      ...
      var element = React.createLeafElement(React.reactPropFields()())(reactClass)({});
