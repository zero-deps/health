  ...
  var errorReactClass = (function () {
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.tr([  ])([ React_DOM.td([ DomOps.cn("align-top") ])([ React_DOM.text(dt) ]), React_DOM.td([ DomOps.cn("align-top"), React_DOM_Props.style({
                  width: "40%"
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([ DomOps.cn("row") ])([ React_DOM.div([ DomOps.cn("col-md-12") ])([ React_DOM.div([ DomOps.cn("card") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
                  ...
                  return [  ];
              })())([ React_DOM.div([ DomOps.cn("card-body") ])([ React_DOM.div([ DomOps.cn("table-responsive") ])([ React_DOM.table([ DomOps.cn("table tablesorter") ])([ React_DOM.thead([ DomOps.cn("text-primary") ])([ React_DOM.tr([  ])([ React_DOM.th([  ])([ React_DOM.text("Time") ]), React_DOM.th([  ])([ React_DOM.text("Exception") ]), React_DOM.th([  ])([ React_DOM.text("Stacktrace") ]) ]) ]), React_DOM.tbody([  ])(Data_Functor.map(Data_Functor.functorArray)(function (x) {
  ...
  var reactClass = (function () {
      ...
      var othCard = function (p) {
          ...
          return card("Other Metrics")([ React_DOM["th'"]([ React_DOM.text("Name") ]), React_DOM.th([ DomOps.cn("text-right") ])([ React_DOM.text("Value") ]), React_DOM["th'"]([ React_DOM.text("Unit") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Uptime") ]), React_DOM.td([ DomOps.cn("text-right"), React_DOM_Props.style({
              ...
              fontFamily: "Fira Code"
          }), React_DOM_Props.colSpan(2) ])([ React_DOM.text(Data_Maybe.fromMaybe("--")(p.version)) ]) ]) ])(Data_Array.concatMap(function (v) {
              if (v.name === "kvs.size") {
                  return Data_Array.singleton(React_DOM.tr([  ])([ React_DOM.td([  ])([ React_DOM.text("Database") ]), React_DOM.td([ DomOps.cn("text-center"), React_DOM_Props.colSpan(2) ])([ React_DOM.text(v.value) ]) ]));
              };
              return [  ];
          })(p.metrics)));
      };
...
(function($PS) {
  ...
  var showMenu = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 51, column 1 - line 54, column 23): " + [ v.constructor.name ]);
  });
  var menuIcon = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 56, column 1 - line 56, column 27): " + [ v.constructor.name ]);
  };
  ...
  var reactClass = (function () {
      var render = function ($$this) {
          ...
          var menuContent = function (v) {
              if (v.menu instanceof Nodes && v.node instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 155, column 9 - line 158, column 74): " + [ v1.constructor.name ]);
              };
          ...
          var $$goto = function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 183, column 7 - line 183, column 34): " + [ v.constructor.name ]);
          };
          return function __do() {
              var s = React.getState($$this)();
              var props = React.getProps($$this)();
          ...
          return function (bytes) {
              var updateWith = function (a) {
                  return function __do() {
                      ...
                      var metrics = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 276, column 23 - line 278, column 28): " + [ a.metrics.constructor.name ]);
                      })();
                      var mem = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 280, column 16 - line 288, column 34): " + [ cpu_mem.constructor.name ]);
                      })();
                      ...
                      var fs = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 294, column 15 - line 301, column 34): " + [ v.constructor.name ]);
                      })();
                      var fd = (function () {
                          var v = Control_Bind.bind(Data_Maybe.bindMaybe)(a.metrics)(function (v1) {
                              return v1.fd;
                          ...
                          throw new Error("Failed pattern match at Main (line 303, column 15 - line 309, column 34): " + [ v.constructor.name ]);
                      })();
                      var thr = (function () {
                          var v = Control_Bind.bind(Data_Maybe.bindMaybe)(a.metrics)(function (v1) {
                              return v1.thr;
                          ...
                          throw new Error("Failed pattern match at Main (line 311, column 16 - line 320, column 34): " + [ v.constructor.name ]);
                      })();
              ...
              if (v instanceof Data_Either.Right && (v.value0.val instanceof Api_Push.StatMsg && v.value0.val.value0.stat instanceof Api_Push["Error"])) {
                  ...
                  var err = {
                      ...
                      st: v.value0.val.value0.stat.value0.st,
                      time: v.value0.val.value0.time,
                      key: key
                  };
                  return updateWith({
              ...
              throw new Error("Failed pattern match at Main (line 199, column 7 - line 263, column 39): " + [ v.constructor.name ]);
          };
      };
      ...
      return React.component()("Main")(function ($$this) {
          return function __do() {
              var locationHost = DomOps.hostname();
              var h = Data_Maybe.fromMaybe("")(locationHost) + ":8001";
